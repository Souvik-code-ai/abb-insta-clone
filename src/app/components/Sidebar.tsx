...
import {
  Home, Calendar, Monitor, LayoutGrid, Zap, Globe,
...
export function Sidebar({ activeSection, onNavigate, onMoreClick }: SidebarProps) {
      ...
      <nav className="flex flex-col py-3 px-3 flex-1">
        ...
        >
          <div
            ...
            style={{
              width: 28, height: 28,
              background: "linear-gradient(135deg, var(--accent) 0%, #f9a8c9 100%)",
            }}
          >
            <span style={{ color: "#fff", fontFamily: "var(--font-family-display)", fontSize: 14, lineHeight: 1 }}>A</span>
          </div>
        </button>
