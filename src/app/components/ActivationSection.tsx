...
export function ActivationSection({ onNavigate }) {
  ...
  const ACTIVATIONS_ALL = [
    ...
    },
    {
      ...
      type: "Festival",
      image: mallCover,
      gallery: [mall1, mall2, mall3, mall4],
      audience: "50K+",
      highlights: [
    ...
    },
    {
      ...
      image: rallyCover,
      gallery: [rally1, rally2, rally3, rally4, rally5, rally6],
      audience: "15K+",
      highlights: [
    ...
    {
      id: 4,
      title: "Arun Iceacream Prmomtion",
      type: "Corporate Engagement",
      image: tataCover,
      gallery: [tata1, tata2, tata3, tata4, tata5, tata6],
      audience: "8K+",
      highlights: [
