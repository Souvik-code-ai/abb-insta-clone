...
// Layout constants — used to compute exact pixel offsets for the
// adjacent cards relative to the main card's center, so the main
// card always stays pinned to the true viewport center regardless
// of how many adjacent cards exist on either side.
...
function getAdjacentOffset(rank: number) {
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        onClick={onClose}
      >
        {/* Full-bleed stage. Every card inside is positioned absolutely
            relative to this box's exact center, so the main card is
            always pinned to the true viewport center — independent of
            how many adjacent cards render on either side. */}
